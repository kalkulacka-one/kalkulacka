  ...
  return (
    <Card corner="topLeft" shadow="hard" className="border border-slate-200">
      <div className="p-3 sm:p-6 flex flex-col gap-4">
        ...
        <h3 className="font-display text-2xl sm:text-3xl font-bold text-gray-700 leading-tight tracking-tighter break-words">{statement}</h3>
        {detail && <p className="text-sm sm:text-base text-gray-700 leading-relaxed max-w-prose break-words tracking-wide">{detail}</p>}
      </div>
    </Card>
  );
}
