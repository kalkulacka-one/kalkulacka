...
const request = new Request("http://localhost/api/assets/inventura-2023-2025/images/avatar.png");
const assetPath = ["inventura-2023-2025", "images", "avatar.png"];
...
describe("GET /api/assets", () => {
  it("mirrors an image with its type, nosniff and caching headers, fetched from under the data endpoint", async () => {
    ...
    expect(String(fetchMock.mock.calls[0]?.[0])).toBe("https://cdn.example/site/inventura-2023-2025/images/avatar.png");
  });
