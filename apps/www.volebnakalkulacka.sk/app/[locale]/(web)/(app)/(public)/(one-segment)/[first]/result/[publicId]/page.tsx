...
export async function generateMetadata({ params: routeParams }: { params: Promise<{ locale: Locale; first: string; publicId: string }> }): Promise<Metadata> {
...
export default async function Page({ params }: { params: Promise<{ first: string; publicId: string }> }) {
  ...
  // ranking under a headline claiming somebody's zhoda.
