...
export function PublicResultPageWithData({ algorithmMatches, answers, segments }: PublicResultPageWithData) {
   ...
   * store there would render — and serve — "Zatiaľ nie je čo počítať" for a
   * beat before the ranking replaced it. Nested inside the route's providers,
   * so the store every other screen reads is never written.
   */
  ...
  /*
   * "Vyplniť vlastnú kalkulačku" — the intro, where the visitor's own
