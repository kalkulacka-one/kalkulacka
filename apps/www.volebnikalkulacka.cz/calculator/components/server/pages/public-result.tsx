import { type CalculatorViewModel, Layout, PublicResultNavigationCard, type ResultViewModel } from "@kalkulacka-one/app";
import { MatchCard, WithCondenseOnScroll } from "@kalkulacka-one/app/client";
