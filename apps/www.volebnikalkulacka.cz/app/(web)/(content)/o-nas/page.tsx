      ...
      <div className="ko:space-y-6">
        <section>
          ...
          <p>
            ...
            <a 
              href="https://cs.wikipedia.org/wiki/Volební_kalkulačka" 
              className="ko:text-primary ko:underline hover:ko:no-underline"
              target="_blank"
        ...
        <section>
          ...
          <div className="ko:space-y-3">
            <div>
              ...
              <p className="ko:text-sm ko:text-gray-600">
        ...
        <section>
          ...
          <div className="ko:grid ko:grid-cols-1 ko:md:grid-cols-2 ko:gap-4">
            <div className="ko:space-y-3">
              <div>
                <a 
                  href="https://www.linkedin.com/in/skopmichal/" 
              ...
              <div>
                <a 
                  href="https://www.linkedin.com/in/krystofk/" 
                  className="ko:text-primary ko:underline hover:ko:no-underline ko:font-medium"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div>
                <a 
                  href="https://www.linkedin.com/in/mwenisch/" 
                  className="ko:text-primary ko:underline hover:ko:no-underline ko:font-medium"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="ko:space-y-3">
              <div>
                <a 
                  href="https://www.linkedin.com/in/mew-dev/" 
                  className="ko:text-primary ko:underline hover:ko:no-underline ko:font-medium"
                  target="_blank"
                  rel="noopener noreferrer"
                >
