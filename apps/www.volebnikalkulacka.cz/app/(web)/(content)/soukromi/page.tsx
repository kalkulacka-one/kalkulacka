        ...
        <section>
          ...
          <div className="ko:space-y-3">
            <div className="ko:flex ko:items-start ko:gap-3">
              <div className="ko:w-2 ko:h-2 ko:bg-primary ko:rounded-full ko:mt-2 ko:flex-shrink-0"></div>
              <p className="ko:text-gray-700">
        ...
        <section>
          ...
          <div className="ko:bg-yellow-50 ko:p-4 ko:rounded-lg ko:border-l-4 ko:border-yellow-400 ko:mb-4">
            <p className="ko:text-gray-700 ko:mb-3">
              Stejně jako my máme svá práva a povinnosti při zpracování Vašich osobních údajů, máte i Vy určitá práva. Všechna tato práva, stejně jako dotazy či stížnosti, můžete uplatnit na e-mailové adrese{" "}
              <a 
              ...
              <div className="ko:flex ko:items-start ko:gap-3">
                ...
                <div>
                  ...
                  <p className="ko:text-gray-700">
                    ...
                    <span className="ko:font-medium">Úřad pro ochranu osobních údajů, Pplk. Sochora 27, 170 00 Praha 7</span>.
                  </p>
                </div>
              </div>
            </div>
