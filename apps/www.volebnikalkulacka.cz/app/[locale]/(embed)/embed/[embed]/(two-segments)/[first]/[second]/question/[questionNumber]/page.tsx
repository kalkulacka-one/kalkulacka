...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; embed: string; first: string; second: string; questionNumber: string }> }): Promise<Metadata> {
