...
const calculatorData: CalculatorData = {
  data: {
    calculator: {
      ...
      // A group calculator, named by the config rather than by the data.
      calculatorGroup: { id: "11111111-1111-4111-8111-111111111111", key: "snemovni-2025" },
      variant: { key: "kalkulacka" },
    },
    questions: [],
    candidates: [],
    candidatesAnswers: {},
  },
  baseUrl: "https://data.kalkulacka.one/snemovni-2025/kalkulacka",
};

const segments = { first: "volby", second: "snemovni-2025", third: "kalkulacka" };
...
describe("PublicResultPageWithData", () => {
  ...
  it("renders the results screen read-only, replaying the stored ranking under the configured names", () => {
  ...
  it("sends the visitor to the calculator's intro for their own calculator, and from the empty state's exit too", () => {
    ...
    expect(push).toHaveBeenNthCalledWith(1, "/volby/snemovni-2025/kalkulacka/uvod");
    expect(push).toHaveBeenNthCalledWith(2, "/volby/snemovni-2025/kalkulacka/uvod");
  });
});
