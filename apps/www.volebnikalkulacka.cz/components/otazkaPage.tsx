      ...
      <div>
        ...
        <div className="flex gap-4">
          ...
          <ToggleButton
            ...
            color="primary"
            onChange={() => {
              if ((storeQuestionStep === calculator.questions.length && answers?.[storeQuestionStep - 1]?.answer === null) || answers?.[storeQuestionStep - 1]?.answer === false) {
          ...
          <ToggleButton
            ...
            color="secondary"
            onChange={() => {
              if ((storeQuestionStep === calculator.questions.length && answers?.[storeQuestionStep - 1]?.answer === null) || answers?.[storeQuestionStep - 1]?.answer === true) {
                router.push(`/${params.first}/${params.second}/rekapitulace`);
              }
        ...
        <div className="flex gap-4">
          {storeQuestionStep === storeMaxQuestionStep ? (
            ...
            <Link href={`/${params.first}/${params.second}/navod/1`}>
              <Button color="neutral" variant="link">
                Návod
              </Button>
            </Link>
