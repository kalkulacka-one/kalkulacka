          ...
          <ExpandableCard.Content className="koa:grid koa:gap-3 koa:p-4 koa:sm:gap-4 koa:sm:p-6 koa:text-left">
            <div className="koa:grid koa:grid-cols-[auto_1fr_auto] koa:gap-4 koa:items-center">
              {candidate.avatar ? (
                ...
                <div
                  className={`koa:flex koa:h-20 koa:w-20 koa:items-center koa:justify-center koa:rounded-2xl ${order === 1 ? "koa:bg-primary koa:text-on-bg-primary" : "koa:bg-surface koa:text-text-strong"}`}
                >
