export function Logo(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 65" fill="none" role="img" aria-labelledby="logo" {...props}>
      <title id="logo">Logo volební kalkulačky</title>
      <path d="M65.9601 0.28401L77.9054 12.248L37.9138 52.3008L25.9684 64.2647L0 38.2562L11.9454 26.2923L25.9684 40.337L65.9601 0.28401Z" fill="var(--primary-50)" />
      <path d="M126.768 0.283997L74.8308 52.3007L86.7762 64.2647L138.713 12.248L126.768 0.283997Z" fill="var(--neutral-10)" />
      <path
      ...
      <path
        ...
        fill="var(--primary-50)"
      />
      <path d="M288.036 0.28401L236.099 52.3007L248.044 64.2647L299.981 12.248L288.036 0.28401Z" fill="var(--neutral-10)" />
      <path
