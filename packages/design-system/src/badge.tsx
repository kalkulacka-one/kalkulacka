...
const badge = cva(
  [
    "k1-inline-flex k1-flex-nowrap k1-items-center k1-gap-1 k1-rounded k1-px-xs k1-py-xxs k1-font-sans k1-text-xs k1-font-bold k1-uppercase k1-leading-4 k1-tracking-wider",
  ],
  {
    variants: {
      color: {
        neutral: ["k1-text-neutral", "k1-bg-neutral"],
        secondary: ["k1-bg-secondary k1-text-secondary-strong"],
      },
    },
  },
);
