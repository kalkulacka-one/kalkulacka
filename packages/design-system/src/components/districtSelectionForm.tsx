                  ...
                  <Radio as={Fragment} value={option.value}>
                    {({ checked }) => (
                      <div className="ko:group ko:flex">
                        <span
                          className={twMerge(
                            'ko:flex ko:size-6 ko:items-center ko:justify-center ko:rounded-full ko:border-2 ko:border-[#565252] ko:group-hover:border-[#ADA6A6] ko:bg-white',
                            checked && 'ko:border-[#565252] ko:after:size-3 ko:after:bg-[#565252] ko:after:rounded-full ko:group-hover:after:bg-[#ADA6A6]',
                          )}
                        />
