...
export function LogoSvg({ title, titleId, decorative, ...props }: LogoSvg) {
  return (
    <svg viewBox="0 0 300 65" role="img" xmlns="http://www.w3.org/2000/svg" aria-hidden={decorative ? "true" : "false"} {...props}>
      ...
      <path d="M65.9601 0.28401L77.9054 12.248L37.9138 52.3008L25.9684 64.2647L0 38.2562L11.9454 26.2923L25.9684 40.337L65.9601 0.28401Z" fill="var(--ko-palette-logo-check)" />
      <path d="M126.768 0.283997L74.8308 52.3007L86.7762 64.2647L138.713 12.248L126.768 0.283997Z" fill="var(--ko-palette-logo-slash)" />
      <path
        ...
        fill="var(--ko-palette-logo-cross)"
      />
      <path
        ...
        fill="var(--ko-palette-logo-percent-numerator)"
      />
      ...
      <path
        ...
        fill="var(--ko-palette-logo-percent-denominator)"
      />
    </svg>
  );
}
