...
export function LogoSvg({ titleId, title, text, ...props }: LogoSvg) {
  return (
    <svg
      viewBox="0 0 300 64"
      fill="currentColor"
    ...
    >
      ...
      <path fill="currentColor" className="ko:text-logo-check" d="M65.9601 1.38557e-05L77.9054 11.964L37.9138 52.0168L25.9684 63.9807L0 37.9722L11.9454 26.0083L25.9684 40.053L65.9601 1.38557e-05Z" />
      <path fill="currentColor" className="ko:text-logo-slash" d="M126.768 0L74.8308 52.0167L86.7762 63.9807L138.713 11.964L126.768 0Z" />
      <path
        fill="currentColor"
      ...
      />
      <path fill="currentColor" className="ko:text-logo-percent-slash" d="M288.036 1.38557e-05L236.099 52.0167L248.044 63.9807L299.981 11.964L288.036 1.38557e-05Z" />
      <path
        fill="currentColor"
