import { Fieldset, PillGroup, PillGroupItem, Legend } from '@repo/design-system/components';
  ...
  return (
    <form aria-labelledby="filter form">
      <Fieldset>
        ...
        <PillGroup>
          <PillGroupItem value="selectall" togglePill={toggleAllItems}>Vybrat vše</PillGroupItem>
