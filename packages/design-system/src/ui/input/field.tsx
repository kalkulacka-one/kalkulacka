...
const fieldVariants = cva(
  [
    "k1-relative k1-flex k1-w-full k1-items-center k1-gap-2 k1-rounded-[1rem] k1-rounded-br-none k1-border k1-border-neutral k1-p-4 focus-within:k1-outline focus-within:k1-outline-2 focus-within:k1-outline-offset-2 focus-within:k1-outline-primary-30 disabled:k1-border-neutral-disabled",
  ],
  {
    variants: {
      state: {
        default: [
          "k1-bg-white k1-text-neutral-strong focus-visible:k1-border-neutral-active",
