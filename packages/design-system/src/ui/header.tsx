    ...
    <header className="ko:max-w-[100vw] ko:left-0 ko:sticky" style={{ gridArea: 'header' }}>
      ...
      >
        <div className="ko:flex ko:items-center" style={{ gridArea: 'logo' }}>
          ...
          <div className="ko:ml-[0.563rem] ko:hidden ko:font-bold ko:font-display ko:text-[0.812rem] ko:uppercase ko:sm:block">Volební kalkulačka</div>
        </div>
        <div style={{ gridArea: 'title' }}>{/* title content */}</div>
