...
export function createSessionImageRoute({ electionName, appTitle, shareHeading, shareCta, fillCta }: SessionImageRouteConfig) {
  async function GET(_request: NextRequest, { params }: { params: Promise<{ "public-id": string; type: string }> }) {
    try {
